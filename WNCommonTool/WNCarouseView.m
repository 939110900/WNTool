...
@interface WNCarouseView ()<UIScrollViewDelegate>
...
- (void)setContent {
    ...
    for (int i = 0; i < self.scrollView.subviews.count; i++) {
        ...
        [imageBtn setBackgroundImage:self.imagesArray[index] forState:UIControlStateNormal];
        [imageBtn setBackgroundImage:self.imagesArray[index] forState:UIControlStateHighlighted];
